const phases = [
  ...
  { label: "Registration", range: "Days 12–15", progress: 76, status: "Gateway testing", detail: "Tickets, orders, manual review, Paystack initialization, signed webhooks, reconciliation and idempotent entitlements are built." },
