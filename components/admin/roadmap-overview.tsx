const phases = [
  ...
  { label: "Registration", range: "Days 12–15", progress: 36, status: "Commerce foundation", detail: "Tickets, inventory, orders, manual review and idempotent entitlements are built; Paystack verification follows." },
