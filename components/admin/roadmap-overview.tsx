const phases = [
  ...
  { label: "Experience", range: "Every day", progress: 55, status: "Critical actions accessible", detail: "Payment, safety, privacy and readiness decisions now use guided dialogs with inline validation. Remaining operational prompts, cross-browser QA and non-technical user testing remain." },
];
