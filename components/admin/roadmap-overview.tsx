const phases = [
  ...
  { label: "Experience", range: "Every day", progress: 82, status: "Core interactions accessible", detail: "Every Admin and member critical action now uses a guided dialog with inline validation. Cross-browser QA and non-technical user testing remain." },
];
