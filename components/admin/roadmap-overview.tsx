const phases = [
  ...
  { label: "Network", range: "Days 16–30", progress: 92, status: "Retention foundations", detail: "Marketplace, feedback, Communities, Learning and vouched referral foundations are built; production acceptance remains." },
];
