export const faqs = [
  ...
  ["Who can join during the limited pilot?", "The pilot is invitation and approval based. Ticket holders, approved founding members, and vouched applicants can request a place. Signing in confirms your email; it does not automatically grant membership."],
