...
export default async function MemberHomePage() {
  ...
  return (
    <main className="member-home-page">
      <header className="member-home-header"><Link className="brand" href="/"><span className="brand-mark">H</span><span>Her Africa Table<small>Member house</small></span></Link><nav>{membershipFlagResult.data?.enabled?<Link href="/membership">Membership</Link>:null}{accessStatus==="active"?<><Link href="/network">Member network</Link><Link href="/opportunities">Asks &amp; Offers</Link>{circleFlagResult.data?.enabled?<Link href="/circles">Circles</Link>:null}{communityFlagResult.data?.enabled?<Link href="/communities">Communities</Link>:null}{learningFlagResult.data?.enabled?<Link href="/learning">Learning</Link>:null}{referralFlagResult.data?.enabled?<Link href="/referrals">Invite</Link>:null}<Link href="/messages">Messages</Link></>:null}<Link href="/events">Upcoming tables</Link><Link href="/notifications">Notifications</Link><Link href="/support">Support</Link><Link href="/settings">Settings</Link></nav></header>
