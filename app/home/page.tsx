...
export default async function MemberHomePage() {
  ...
  return (
    <main className="member-home-page">
      <header className="member-home-header"><Link className="brand" href="/"><span className="brand-mark">H</span><span>Her Africa Table<small>Member house</small></span></Link><Link href="/events">Upcoming tables</Link></header>
