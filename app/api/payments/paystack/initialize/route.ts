...
export async function POST(request:Request){
 try{
  ...
  try{
   const item=(order.order_items as unknown as {community_host_plan_id:string|null;community_offer_id:string|null;course_id:string|null;membership_plan_id:string|null}[]|null)?.[0];
