...
export default function CommunityGuidelinesPage() {
  return (
    <LegalPage eyebrow="How we share the table" title="Community Guidelines" intro="The table works when every member can contribute with confidence, curiosity, generosity, and clear professional boundaries.">
      ...
      <section><h2>Use safety tools</h2><p>You can quietly decline a connection, block a member, or report a profile, message or post. Tell us what happened so the Her Africa Table safety team can respond fairly.</p></section>
